...
final class SeedData {
    ...
    private static PlaceSpec p(String name, String city, String country, double lat, double lng,
                              double cost, List<Interest> interests, String description) {
        return new PlaceSpec(name, country, city, null, lat, lng, cost, interests, description);
    }
    ...
    private static List<PlaceSpec> buildPlaces() {
        ...
        // --- CABA (33) ---
        l.add(p("MALBA", "Buenos Aires", "Argentina", -34.5777, -58.4033, 12.0, List.of(Interest.CULTURE), "Modern Latin American art in a bright Palermo building."));
        l.add(p("Cementerio de la Recoleta", "Buenos Aires", "Argentina", -34.5875, -58.3936, 0.0, List.of(Interest.HISTORY), "Ornate mausoleums and the resting place of Eva Perón."));
        l.add(p("Bosques de Palermo", "Buenos Aires", "Argentina", -34.5710, -58.4170, 0.0, List.of(Interest.NATURE), "Lakes, rose garden and pedal boats in the city's green lung."));
        l.add(p("Puerto Madero", "Buenos Aires", "Argentina", -34.6110, -58.3630, 0.0, List.of(Interest.CULTURE), "Reclaimed docklands with the Puente de la Mujer and riverside walks."));
        l.add(p("Floralis Genérica", "Buenos Aires", "Argentina", -34.5829, -58.3925, 0.0, List.of(Interest.CULTURE), "Giant steel flower that opens and closes with the sun."));
        l.add(p("Planetario Galileo Galilei", "Buenos Aires", "Argentina", -34.5694, -58.4114, 8.0, List.of(Interest.CULTURE), "Dome shows about the southern skies in a striking modernist building."));
        l.add(p("Jardín Japonés", "Buenos Aires", "Argentina", -34.5760, -58.4110, 6.0, List.of(Interest.NATURE), "Koi ponds, bonsai and a teahouse in a serene corner of Palermo."));
        l.add(p("Plaza de Mayo", "Buenos Aires", "Argentina", -34.6083, -58.3722, 0.0, List.of(Interest.HISTORY), "The political heart of the country, ringed by historic buildings."));
        l.add(p("Casa Rosada", "Buenos Aires", "Argentina", -34.6080, -58.3702, 0.0, List.of(Interest.HISTORY), "The pink presidential palace with its famous balcony."));
        l.add(p("El Ateneo Grand Splendid", "Buenos Aires", "Argentina", -34.5959, -58.3937, 0.0, List.of(Interest.SHOPPING, Interest.CULTURE), "A bookshop inside a century-old theatre, often called the world's most beautiful."));
        l.add(p("Mercado de San Telmo", "Buenos Aires", "Argentina", -34.6206, -58.3716, 0.0, List.of(Interest.SHOPPING, Interest.FOOD), "Antiques, produce and empanadas under a wrought-iron roof."));
        l.add(p("Usina del Arte", "Buenos Aires", "Argentina", -34.6286, -58.3568, 0.0, List.of(Interest.CULTURE), "A former power plant turned concert hall in La Boca."));
        l.add(p("Reserva Ecológica Costanera Sur", "Buenos Aires", "Argentina", -34.6120, -58.3500, 0.0, List.of(Interest.NATURE), "Birdwatching and river views on trails beside Puerto Madero."));
        l.add(p("Centro Cultural Kirchner", "Buenos Aires", "Argentina", -34.6075, -58.3702, 0.0, List.of(Interest.CULTURE), "Huge cultural centre with free concerts in the old post office."));
        l.add(p("Estadio Monumental", "Buenos Aires", "Argentina", -34.5453, -58.4498, 20.0, List.of(Interest.SPORTS), "Home of River Plate and the national team, with a stadium museum."));
        l.add(p("La Bombonera", "Buenos Aires", "Argentina", -34.6356, -58.3647, 18.0, List.of(Interest.SPORTS), "Boca Juniors' steep, deafening stadium in La Boca."));
        l.add(p("Barrio Chino de Belgrano", "Buenos Aires", "Argentina", -34.5610, -58.4540, 0.0, List.of(Interest.FOOD), "A compact, lively Chinatown for dumplings and bubble tea."));
        l.add(p("Galerías Pacífico", "Buenos Aires", "Argentina", -34.6010, -58.3750, 0.0, List.of(Interest.SHOPPING), "Frescoed shopping arcade on pedestrian Calle Florida."));
        l.add(p("Avenida Corrientes", "Buenos Aires", "Argentina", -34.6038, -58.3850, 0.0, List.of(Interest.CULTURE), "The never-sleeping theatre, bookshop and pizza strip."));
        l.add(p("Congreso de la Nación", "Buenos Aires", "Argentina", -34.6097, -58.3925, 0.0, List.of(Interest.HISTORY), "The grand domed parliament building and its plaza."));
        l.add(p("Café Tortoni", "Buenos Aires", "Argentina", -34.6086, -58.3780, 0.0, List.of(Interest.FOOD), "The city's oldest café, all marble, mirrors and tango."));
        l.add(p("Palermo Soho", "Buenos Aires", "Argentina", -34.5880, -58.4250, 0.0, List.of(Interest.NIGHTLIFE), "Cobbled streets packed with bars, design shops and street art."));
        l.add(p("Feria de Mataderos", "Buenos Aires", "Argentina", -34.6580, -58.5050, 0.0, List.of(Interest.CULTURE), "Folk music, gaucho skills and regional food on weekends."));
        l.add(p("Jardín Botánico Carlos Thays", "Buenos Aires", "Argentina", -34.5817, -58.4170, 0.0, List.of(Interest.NATURE), "Greenhouses and shaded paths in the middle of Palermo."));
        l.add(p("Museo Nacional de Bellas Artes", "Buenos Aires", "Argentina", -34.5840, -58.3930, 0.0, List.of(Interest.CULTURE), "Free national gallery with European masters and Argentine art."));
        l.add(p("Mercado de Abasto", "Buenos Aires", "Argentina", -34.6037, -58.4106, 0.0, List.of(Interest.SHOPPING), "A landmark Art Deco market turned shopping mall."));
        l.add(p("Parque Centenario", "Buenos Aires", "Argentina", -34.6066, -58.4350, 0.0, List.of(Interest.NATURE), "A circular park with a weekend craft and book fair."));
        l.add(p("Luna Park", "Buenos Aires", "Argentina", -34.6020, -58.3690, 25.0, List.of(Interest.NIGHTLIFE), "The historic downtown arena for boxing and big concerts."));
        l.add(p("Plaza Dorrego", "Buenos Aires", "Argentina", -34.6205, -58.3712, 0.0, List.of(Interest.CULTURE), "San Telmo's antiques square with Sunday street tango."));
        l.add(p("Barrancas de Belgrano", "Buenos Aires", "Argentina", -34.5610, -58.4560, 0.0, List.of(Interest.NATURE), "A leafy park with weekend milongas under the trees."));
        l.add(p("Calle Florida", "Buenos Aires", "Argentina", -34.6000, -58.3750, 0.0, List.of(Interest.SHOPPING), "The busy downtown pedestrian shopping street."));
        l.add(p("Distrito Arcos", "Buenos Aires", "Argentina", -34.5760, -58.4290, 0.0, List.of(Interest.SHOPPING), "Open-air outlet mall under restored railway arches."));
        l.add(p("Ciudad Cultural Konex", "Buenos Aires", "Argentina", -34.6040, -58.4110, 15.0, List.of(Interest.NIGHTLIFE), "Industrial venue famous for its Monday-night drum show."));

        // --- Argentine provinces (17) ---
        l.add(p("Quebrada de Cafayate", "Cafayate", "Argentina", -26.0731, -65.9786, 0.0, List.of(Interest.NATURE), "Wind-sculpted red canyons on the road through Salta's wine country."));
        l.add(p("Salinas Grandes", "Jujuy", "Argentina", -23.6260, -66.0960, 10.0, List.of(Interest.NATURE), "A blinding white salt flat high on the Andean plateau."));
        l.add(p("Cerro de los Siete Colores", "Purmamarca", "Argentina", -23.7450, -65.5000, 0.0, List.of(Interest.NATURE, Interest.HISTORY), "The seven-coloured hill glowing above an adobe village."));
        l.add(p("Villa Carlos Paz", "Córdoba", "Argentina", -31.4241, -64.4978, 0.0, List.of(Interest.NIGHTLIFE), "A lakeside resort town buzzing in the summer season."));
        ...
        l.add(p("Tren del Fin del Mundo", "Ushuaia", "Argentina", -54.8019, -68.3030, 40.0, List.of(Interest.ADVENTURE), "A steam train into the forests of the world's southernmost city."));
        l.add(p("Parque Nacional Tierra del Fuego", "Ushuaia", "Argentina", -54.8500, -68.5500, 25.0, List.of(Interest.NATURE), "Peat bogs, lakes and coastal trails at the end of the continent."));
        l.add(p("Península Valdés", "Puerto Madryn", "Argentina", -42.5000, -63.9500, 30.0, List.of(Interest.NATURE), "Whales, sea lions and penguins on a wild Atlantic peninsula."));
        l.add(p("Puerto Madryn Costanera", "Puerto Madryn", "Argentina", -42.7692, -65.0385, 0.0, List.of(Interest.BEACH), "A breezy seaside promenade and gateway to marine life."));
        l.add(p("Circuito Chico", "San Carlos de Bariloche", "Argentina", -41.1000, -71.5000, 0.0, List.of(Interest.NATURE, Interest.MOUNTAINS), "A scenic loop of lakes and viewpoints around Bariloche."));
        l.add(p("Villa La Angostura", "Neuquén", "Argentina", -40.7641, -71.6420, 0.0, List.of(Interest.NATURE), "A lakeside woodland town on the Route of the Seven Lakes."));
        l.add(p("San Martín de los Andes", "Neuquén", "Argentina", -40.1579, -71.3525, 0.0, List.of(Interest.MOUNTAINS, Interest.NATURE), "A charming mountain town at the foot of Lácar lake."));
        l.add(p("Termas de Río Hondo", "Santiago del Estero", "Argentina", -27.4936, -64.8580, 0.0, List.of(Interest.OTHER), "A spa town built around its thermal mineral waters."));
        l.add(p("Monumento a la Bandera", "Rosario", "Argentina", -32.9468, -60.6303, 0.0, List.of(Interest.HISTORY), "A monumental tribute to the Argentine flag beside the Paraná."));
        l.add(p("Torreón del Monje", "Mar del Plata", "Argentina", -38.0230, -57.5290, 0.0, List.of(Interest.BEACH), "A clifftop landmark over Mar del Plata's beaches."));
        l.add(p("El Chaltén", "El Chaltén", "Argentina", -49.3300, -72.8860, 0.0, List.of(Interest.MOUNTAINS, Interest.ADVENTURE), "Argentina's trekking capital beneath the Fitz Roy massif."));
        l.add(p("Dique Cabra Corral", "Salta", "Argentina", -25.2700, -65.3300, 0.0, List.of(Interest.ADVENTURE, Interest.NATURE), "A vast reservoir for kayaking, sailing and bungee jumps."));

        // --- Rest of the world (40) ---
        l.add(p("Cristo Redentor", "Rio de Janeiro", "Brazil", -22.9519, -43.2105, 25.0, List.of(Interest.CULTURE), "The arms-open statue watching over Rio from Corcovado."));
        l.add(p("Pão de Açúcar", "Rio de Janeiro", "Brazil", -22.9486, -43.1566, 30.0, List.of(Interest.NATURE), "Cable cars to Sugarloaf for sweeping bay views."));
        l.add(p("Machu Picchu", "Cusco", "Peru", -13.1631, -72.5450, 50.0, List.of(Interest.HISTORY), "The cloud-wrapped Inca citadel high in the Andes."));
        l.add(p("Torres del Paine", "Puerto Natales", "Chile", -51.0000, -73.0000, 35.0, List.of(Interest.MOUNTAINS, Interest.NATURE), "Granite spires, glaciers and turquoise lakes in Patagonia."));
        l.add(p("Desierto de Atacama", "San Pedro de Atacama", "Chile", -23.8500, -69.2300, 0.0, List.of(Interest.NATURE, Interest.ADVENTURE), "The driest desert on Earth, with geysers and salt lagoons."));
        l.add(p("Rambla de Montevideo", "Montevideo", "Uruguay", -34.9000, -56.1600, 0.0, List.of(Interest.BEACH), "A long riverside promenade made for sunset strolls and mate."));
        l.add(p("Punta del Este", "Punta del Este", "Uruguay", -34.9500, -54.9500, 0.0, List.of(Interest.BEACH, Interest.NIGHTLIFE), "Beaches by day and a lively scene by night."));
        l.add(p("Cartagena Old Town", "Cartagena", "Colombia", 10.4236, -75.5518, 0.0, List.of(Interest.CULTURE, Interest.HISTORY), "Walled colonial streets in colour on the Caribbean coast."));
        l.add(p("Salar de Uyuni", "Uyuni", "Bolivia", -20.1338, -67.4891, 20.0, List.of(Interest.NATURE), "The world's largest salt flat, a mirror after the rains."));
        l.add(p("Chichén Itzá", "Yucatán", "Mexico", 20.6843, -88.5678, 30.0, List.of(Interest.HISTORY), "The great Maya pyramid of El Castillo."));
        l.add(p("Playas de Cancún", "Cancún", "Mexico", 21.1619, -86.8515, 0.0, List.of(Interest.BEACH), "Turquoise Caribbean water and white sand."));
        l.add(p("Times Square", "New York", "United States", 40.7580, -73.9855, 0.0, List.of(Interest.NIGHTLIFE), "The blazing crossroads of Manhattan's theatre district."));
        l.add(p("Golden Gate Bridge", "San Francisco", "United States", 37.8199, -122.4783, 0.0, List.of(Interest.CULTURE), "The iconic red suspension bridge over the bay."));
        l.add(p("Grand Canyon", "Arizona", "United States", 36.1069, -112.1129, 35.0, List.of(Interest.NATURE), "A mile-deep gorge carved by the Colorado River."));
        l.add(p("Niagara Falls", "Ontario", "Canada", 43.0962, -79.0377, 0.0, List.of(Interest.NATURE), "Thundering falls you can ride a boat right beneath."));
        l.add(p("Banff National Park", "Alberta", "Canada", 51.4968, -115.9281, 0.0, List.of(Interest.MOUNTAINS, Interest.NATURE), "Glacier-fed turquoise lakes ringed by the Rockies."));
        l.add(p("Tour Eiffel", "Paris", "France", 48.8584, 2.2945, 28.0, List.of(Interest.CULTURE), "The wrought-iron symbol of Paris above the Champ de Mars."));
        l.add(p("Musée du Louvre", "Paris", "France", 48.8606, 2.3376, 22.0, List.of(Interest.CULTURE, Interest.HISTORY), "The world's most visited museum, home to the Mona Lisa."));
        l.add(p("Colosseo", "Rome", "Italy", 41.8902, 12.4922, 18.0, List.of(Interest.HISTORY), "The vast amphitheatre at the centre of ancient Rome."));
        l.add(p("Canales de Venecia", "Venice", "Italy", 45.4408, 12.3155, 0.0, List.of(Interest.CULTURE), "A maze of canals, bridges and gondolas."));
        l.add(p("Sagrada Família", "Barcelona", "Spain", 41.4036, 2.1744, 26.0, List.of(Interest.CULTURE), "Gaudí's still-unfinished basilica of soaring stone."));
        l.add(p("Park Güell", "Barcelona", "Spain", 41.4145, 2.1527, 10.0, List.of(Interest.CULTURE, Interest.NATURE), "Gaudí's mosaic terraces overlooking the city."));
        l.add(p("Puerta del Sol", "Madrid", "Spain", 40.4168, -3.7038, 0.0, List.of(Interest.CULTURE), "Madrid's lively central square and kilometre zero."));
        l.add(p("Big Ben & Westminster", "London", "United Kingdom", 51.5007, -0.1246, 0.0, List.of(Interest.HISTORY), "The clock tower beside the Houses of Parliament."));
        l.add(p("Tower Bridge", "London", "United Kingdom", 51.5055, -0.0754, 0.0, List.of(Interest.HISTORY), "The Victorian bascule bridge over the Thames."));
        l.add(p("Brandenburger Tor", "Berlin", "Germany", 52.5163, 13.3777, 0.0, List.of(Interest.HISTORY), "The neoclassical gate at the heart of Berlin."));
        l.add(p("Casa de Ana Frank", "Amsterdam", "Netherlands", 52.3752, 4.8840, 16.0, List.of(Interest.HISTORY), "The canal house where Anne Frank wrote her diary."));
        l.add(p("Santorini", "Santorini", "Greece", 36.3932, 25.4615, 0.0, List.of(Interest.BEACH), "Whitewashed cliffs and blue domes over the Aegean."));
        l.add(p("Acrópolis de Atenas", "Athens", "Greece", 37.9715, 23.7257, 20.0, List.of(Interest.HISTORY), "The Parthenon crowning the ancient citadel."));
        l.add(p("Pirámides de Giza", "Giza", "Egypt", 29.9792, 31.1342, 22.0, List.of(Interest.HISTORY), "The last standing wonder of the ancient world."));
        l.add(p("Burj Khalifa", "Dubai", "United Arab Emirates", 25.1972, 55.2744, 40.0, List.of(Interest.SHOPPING, Interest.CULTURE), "The world's tallest tower above a glittering city."));
        l.add(p("Taj Mahal", "Agra", "India", 27.1751, 78.0421, 18.0, List.of(Interest.HISTORY), "The marble mausoleum shimmering at dawn."));
        l.add(p("Gran Muralla China", "Beijing", "China", 40.4319, 116.5704, 25.0, List.of(Interest.HISTORY), "Ramparts winding for miles over green ridges."));
        l.add(p("Cruce de Shibuya", "Tokyo", "Japan", 35.6595, 139.7005, 0.0, List.of(Interest.NIGHTLIFE), "The world's busiest pedestrian scramble in neon Tokyo."));
        l.add(p("Monte Fuji", "Fujinomiya", "Japan", 35.3606, 138.7274, 0.0, List.of(Interest.MOUNTAINS), "Japan's perfectly symmetrical sacred volcano."));
        l.add(p("Sydney Opera House", "Sydney", "Australia", -33.8568, 151.2153, 30.0, List.of(Interest.CULTURE), "The sail-roofed icon on Sydney Harbour."));
        l.add(p("Bondi Beach", "Sydney", "Australia", -33.8908, 151.2743, 0.0, List.of(Interest.BEACH, Interest.SPORTS), "A famous surf beach with a clifftop coastal walk."));
        l.add(p("Marina Bay Sands", "Singapore", "Singapore", 1.2834, 103.8607, 23.0, List.of(Interest.SHOPPING), "A rooftop infinity pool above a futuristic skyline."));
        l.add(p("Table Mountain", "Cape Town", "South Africa", -33.9628, 18.4098, 28.0, List.of(Interest.MOUNTAINS, Interest.NATURE), "A flat-topped massif reached by rotating cable car."));
        l.add(p("Blue Lagoon", "Grindavík", "Iceland", 63.8804, -22.4495, 50.0, List.of(Interest.NATURE), "Milky-blue geothermal waters amid black lava fields."));
