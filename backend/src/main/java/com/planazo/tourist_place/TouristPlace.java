...
public class TouristPlace {
    ...
    @CollectionTable(name = "tourist_place_interests", joinColumns = @JoinColumn(name = "place_id"))
    ...
    @ElementCollection(fetch = FetchType.LAZY)
    @CollectionTable(name = "tourist_place_images", joinColumns = @JoinColumn(name = "id_place"))
